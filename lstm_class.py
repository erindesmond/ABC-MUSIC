...
class ABC():
    ...
    def model(self):
        ...
        self.model.add(LSTM(memory_units, input_shape=(self.sequences, len(self.vocabulary)))) #return_sequences=true if you want more LSTMS
...
if __name__ == '__main__':
    ...
    classical_test = 'classical_test.txt'
    sequences = 25
    epochs = 1
    batch_size = 100

    model = ABC(testing_data, sequences, epochs, batch_size).apply_functions()
